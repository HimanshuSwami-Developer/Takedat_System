...
class DocumentUploadStep extends StatefulWidget {
  ...
  @override
  State<DocumentUploadStep> createState() =>
      _DocumentUploadStepState();
}

class _DocumentUploadStepState
    extends State<DocumentUploadStep> {
  ...
  Future<void> loadSession() async {
    ...
    userId = await SessionManager.getString(
      SessionKeys.userId,
    );

    userEmail = await SessionManager.getString(
      SessionKeys.email,
    );
